@extends('layouts.app', ['activePage' => 'eps', 'titlePage' => __('CRUD de Hogar')])
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-12 text-left ml-3 pr-5">
                        <a href="{{ url('cotizacion_eps') }}" class="btn btn-success" target="_blank">REGISTRAR SEGURO EPS</a>
                    </div>

                </div>
                <div class="card">
                    <div class="card-header card-header-success">
                        <h4 class="card-title ">LISTA DE SEGUROS EPS </h4>
                        ...
                        <table id="datatable" class="table table-striped table-responsive d-md-table" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions">
                                        <form action="{{ route('eps.update',$row->id) }}" method="post">
                                            @csrf
                                            @method('put')
                                            @if( $row->id_estado == 0)
                                    ...
                                    <td class="td-actions text-right">
                                        <form action="{{ route('eps.archivar', $row->id) }}" class="form-del" method="post">

                                            @csrf
                                            @method('put')

                                            <a href="{{ route('eps.show', $row->id) }}" class="btn btn-primary btn-link">
